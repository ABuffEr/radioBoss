...
addon_info = {
	...
	"addon_name": "radioBoss",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("RadioBOSS"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-ons manager
	"addon_description": _("""Provides various enhancements for RadioBOSS by DJSoft.Net."""),
	# version
	"addon_version": "1.0.0",
	# Author(s)
	"addon_author": "Alberto Buffolino <a.buffolino@gmail.com>",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/ABuffEr/radioBoss",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/ABuffEr/radioBoss",
...
pythonSources = ["addon/appModules/*.py", "addon/globalPlugins/*.py", "addon/shared/radioBoss/*.py", "addon/installTasks.py"]
